export interface SuggestedPlace {
  ...
  district?: string;
  /**
   * ที่ที่คนมาอำเภอนี้มักไม่พลาด — ติดดาวในรายการและถูกดันขึ้นบนสุด
   *
   * เป็นการคัดโดยคนเขียนข้อมูล ไม่ใช่คะแนนรีวิวจากที่ไหน จึงใส่แค่ 1-3 แห่ง
   * ต่ออำเภอ ถ้าติดดาวหมดทุกแห่งดาวก็ไม่มีความหมาย
   */
  featured?: boolean;
