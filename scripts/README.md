...
เดิมที่เก็บประวัติผูกกับคีย์เดียวเป็นตัวแปรระดับโมดูล พอมีผู้ช่วยช่องที่สอง
(ผู้ช่วยแนะนำที่เที่ยว) ทั้งสองจะเขียนทับกัน — ถามในหน้าแนะนำเที่ยวแล้วประวัติ
ในหน้าผู้ช่วยหายทั้งดุ้น จึงเปลี่ยนเป็น `createChatStore(key)`
